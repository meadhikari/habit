...
public class HabitNotificationService extends IntentService {
    public static final String TODOTEXT = "com.adhikari.bigfootsoftwares.habit.todonotificationservicetext";
    public static final String TODOUUID = "com.adhikari.bigfootsoftwares.habit.todonotificationserviceuuid";
    private String mTodoText;
    private UUID mTodoUUID;
    private Context mContext;

    public HabitNotificationService(){
        super("HabitNotificationService");
    }
    @Override
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("Adhikari", "onHandleIntent called");
        NotificationManager manager = (NotificationManager)getSystemService(NOTIFICATION_SERVICE);
        Intent i = new Intent(this, ReminderActivity.class);
        i.putExtra(HabitNotificationService.TODOUUID, mTodoUUID);
