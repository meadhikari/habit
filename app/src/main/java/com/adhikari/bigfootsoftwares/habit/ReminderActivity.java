...
public class ReminderActivity extends AppCompatActivity{
    ...
    public static final String EXIT = "com.adhikari.bigfootsoftwares.habit.exit";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mHabitItems = MainActivity.getLocallyStoredData(storeRetrieveData);
        ...
        Intent i = getIntent();
        UUID id = (UUID)i.getSerializableExtra(HabitNotificationService.TODOUUID);
        mItem = null;
        for(HabitItem habitItem : mHabitItems){
            if (habitItem.getIdentifier().equals(id)){
                mItem = habitItem;
                break;
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.toDoReminderDoneMenuItem:
                ...
                Log.d("Adhikari", "Date Changed to: " + date);
                changeOccurred();
                saveData();
                closeApp();
                //foo
