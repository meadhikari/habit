...
public class AddHabitActivity extends AppCompatActivity implements  DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
...
//    private TextView mLastSeenTextView;
    ...
    private HabitItem mUserHabitItem;
...
//        setContentView(R.layout.activity_add_to_do);
        ...
        mUserHabitItem = (HabitItem)getIntent().getSerializableExtra(MainActivity.TODOITEM);

        mUserEnteredText = mUserHabitItem.getToDoText();
        mUserHasReminder = mUserHabitItem.hasReminder();
        mUserReminderDate = mUserHabitItem.getToDoDate();
        mUserColor = mUserHabitItem.getTodoColor();


//        if(mUserHabitItem.getLastEdited()==null) {
//            mLastEdited = new Date();
//        }
//        else{
//            mLastEdited = mUserHabitItem.getLastEdited();
//        }
...
//        mLastSeenTextView.setText(String.format(getResources().getString(R.string.last_edited), lastSeen));
        ...
        mDateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Date date;
                hideKeyboard(mToDoTextBodyEditText);
                if(mUserHabitItem.getToDoDate()!=null){
//                    date = mUserHabitItem.getToDoDate();
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(AddHabitActivity.this, year, month, day);
                if(theme.equals(MainActivity.DARKTHEME)){
...
//                    date = mUserHabitItem.getToDoDate();
                ...
                TimePickerDialog timePickerDialog = TimePickerDialog.newInstance(AddHabitActivity.this, hour, minute, DateFormat.is24HourFormat(AddHabitActivity.this));
                if(theme.equals(MainActivity.DARKTHEME)){
...
//        });
    ...
    private void setDateAndTimeEditText(){
        ...
        if(mUserHabitItem.hasReminder() && mUserReminderDate!=null){
...
//            mUserReminderDate = new Date();
            ...
            Log.d("Adhikari", "Imagined Date: "+mUserReminderDate);
            String timeString;
            if(time24){
...
//        setDateAndTimeEditText();
    ...
    public void setReminderTextView(){
        if(mUserReminderDate!=null){
            ...
            if(mUserReminderDate.before(new Date())){
                Log.d("Adhikari", "DATE is "+mUserReminderDate);
    ...
    public void makeResult(int result){
        ...
        if(mUserEnteredText.length()>0){
            ...
            mUserHabitItem.setToDoText(capitalizedString);
        }
        else{
            mUserHabitItem.setToDoText(mUserEnteredText);
        }
//        mUserHabitItem.setLastEdited(mLastEdited);
        if(mUserReminderDate!=null){
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(mUserReminderDate);
        ...
        mUserHabitItem.setHasReminder(mUserHasReminder);
        mUserHabitItem.setToDoDate(mUserReminderDate);
        mUserHabitItem.setTodoColor(mUserColor);
        i.putExtra(MainActivity.TODOITEM, mUserHabitItem);
        setResult(result, i);
    }
    ...
    public void onBackPressed() {
        if(mUserReminderDate.before(new Date())){
            mUserHabitItem.setToDoDate(null);
        }
        makeResult(RESULT_OK);
        super.onBackPressed();
    }
